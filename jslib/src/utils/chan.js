 export default function(extId, chanId) {
     var noop = {
         value: function() {}
     };
     ...
     var dispatch = dispatch("sendMessage",
         "receiveMessage")
     var chromeExtPort;
     var chromeExtID = extId //"djcdicpaejhpgncicoglfckiappkoeof" //TODO Para
     var hasExtension
     var channel = chanId //"cnbChan01" //TODO Parameter
     var connectChan = function() {
         var chan = new BroadcastChannel(channel)
         console.log("connect chan", chanId)
